...
@section('header')
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center">
        <div>
            <h1 class="text-3xl font-bold text-neutral-900">My Tickets</h1>
            <p class="mt-2 text-sm text-neutral-600">View and manage your purchased tickets</p>
        </div>
    </div>
@endsection
                        ...
                        <div class="p-6">
                            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                                ...
                                <div class="mt-2 flex items-center text-sm text-neutral-500">
                                    <svg class="flex-shrink-0 mr-1.5 h-4 w-4 text-neutral-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
